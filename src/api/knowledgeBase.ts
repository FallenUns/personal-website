...
**Notable Projects:**
- **Blipt**: iOS reminder app that understand context and natural language, built with SwiftUI, Core Data, and Firebase. Features include smart scheduling, location-based reminders, and intuitive UI
