...
import {
  ...
  type Transition, type VariantLabels, type Target, type TargetAndTransition,
} from 'framer-motion';

/**
 * RotatingText — ported from react-bits.dev. Cycles through a list of strings,
 * animating each character (or word/line) in/out with staggered springs.
 * Exposes imperative controls via ref for manual stepping.
 */
...
const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>(
  (
    ...
    const previous = useCallback(() => {
      const pi = currentTextIndex === 0 ? (loop ? texts.length - 1 : currentTextIndex) : currentTextIndex - 1;
