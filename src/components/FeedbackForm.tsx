                  ...
                  <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-8 text-center">
                    ...
                    >
                      <div className="w-20 h-20 bg-green-500/20 rounded-full flex items-center justify-center mb-4 mx-auto">
                        <svg aria-hidden="true" className="w-10 h-10 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      >
                        <div className="flex items-center px-4 py-3">
                          <div className="flex-shrink-0">
                            <svg aria-hidden="true" className="w-5 h-5 text-red-400" fill="currentColor" viewBox="0 0 20 20">
